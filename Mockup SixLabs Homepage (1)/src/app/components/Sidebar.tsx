...
const mainNavItems = [
  { icon: Home01, label: "Home", href: "/" },
  { icon: CpuChip01, label: "Context & Skills", href: "/context" },
  { icon: LayersTwo01, label: "Generations", href: "/generations" },
  { icon: Plus, label: "Integrations", href: "/integrations" },
  { icon: BookOpen01, label: "Expert Library", href: "/expert-library" },
];
