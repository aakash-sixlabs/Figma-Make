  ...
  return (
    <div className="flex min-h-screen bg-[#FCFBF9] font-body text-body-text overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden p-1 sm:p-2 md:p-3 lg:p-4">
        <div className="flex-1 bg-white rounded-[16px] sm:rounded-[20px] lg:rounded-[24px] border border-[#F2F0EB] shadow-sm hover:shadow-md hover:border-[#D0D5DD] transition-all duration-300 overflow-y-auto custom-scrollbar relative">
          ...
          <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-12 py-6 sm:py-8 md:py-10 lg:py-12 space-y-8 sm:space-y-10 lg:space-y-12">
            ...
            {/* Header */}
            <div className="flex flex-col sm:flex-row items-start justify-between gap-4 sm:gap-6 border-b border-[#F2F0EB] pb-6 sm:pb-8 lg:pb-10">
              <div className="space-y-2">
                <h1 className="text-2xl sm:text-3xl font-display font-bold text-[#101828] tracking-tight">Integrations</h1>
