...
import sixLabsLogo from "../../imports/Six-Logo_Full.png";
import sixLabsIcon from "../../imports/Six-Icon.png";
...
export default function LoginMVP() {
  ...
  return (
    <div className="flex min-h-screen bg-white font-body text-[#101828] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center px-5 sm:px-8 md:px-12 lg:px-24 xl:px-32 py-8 sm:py-0 relative z-10 bg-white">
        <div className="max-w-md w-full mx-auto space-y-8 sm:space-y-10">
          ...
          <div className="space-y-2 sm:space-y-3">
            ...
            <p className="text-[#667085] text-[14px] sm:text-[15px] font-medium leading-relaxed">
              {isLogin
          ...
          <div className="space-y-3 sm:space-y-4">
            <Button
              ...
              onClick={handleAuth}
              disabled={loading}
              className="w-full h-11 sm:h-12 bg-white text-[#101828] border-[#F2F0EB] hover:bg-[#F9FAFB] rounded-xl font-bold shadow-sm flex items-center justify-center gap-3 transition-all active:scale-[0.98] text-[14px] sm:text-[15px]"
            >
          ...
          <form onSubmit={handleAuth} className="space-y-5 sm:space-y-6">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 sm:h-12 bg-[#101828] text-white hover:bg-[#101828]/90 rounded-xl font-bold shadow-lg shadow-[#101828]/10 group transition-all text-[14px] sm:text-[15px]"
            >
              {loading ? (
      ...
      <div className="hidden lg:flex flex-1 bg-[#F9FAFB] relative overflow-hidden items-center justify-center p-12">
        ...
        >
          <div className="space-y-6">
            <div className="size-14 bg-white rounded-2xl flex items-center justify-center shadow-sm border border-[#F2F0EB] p-2">
              <ImageWithFallback
                src={sixLabsIcon}
                alt="SixLabs"
