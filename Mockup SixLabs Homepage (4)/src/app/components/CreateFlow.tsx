  ...
  return (
    <div className="flex min-h-screen bg-surface font-body text-body-text overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden p-2 md:p-3 lg:p-4">
        ...
        {/* Header */}
        <header className="bg-white border-b border-[#F2F0EB] px-8 py-3 flex items-center justify-between z-20 shadow-sm shrink-0">
          <div className="flex items-center gap-8">
            <Link to="/app" className="p-2 rounded-xl border border-transparent hover:border-[#F2F0EB] hover:bg-[#F9FAFB] transition-all text-[#667085] hover:text-[#101828]">
              <ChevronLeft className="size-5" />
            </Link>
            <div className="h-6 w-px bg-[#F2F0EB] hidden md:block" />
              ...
              {STEPS.map((step, index) => (
                <div key={step.id} className="flex items-center gap-4">
                  ...
                  {index < STEPS.length - 1 && (
                    <div className="ml-6 h-px w-8 bg-[#F2F0EB] hidden 2xl:block" />
                  )}
                </div>
              ))}
            </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="space-y-2">
                  <h1 className="text-3xl font-display font-bold text-[#101828] tracking-tight">
                ...
                <div className="bg-white rounded-[24px] p-6 md:p-8 border border-[#F2F0EB] relative overflow-hidden shadow-sm">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                          ...
                          { id: "brand", label: "Evergreen Brand", desc: "Long-term storytelling focusing on core brand values and lifestyle proposition.", icon: Stars01, variant: "gray" as const },
                            ...
                            className={cn(
                              "flex flex-col gap-4 p-6 rounded-[20px] border text-left transition-all duration-300 h-full group relative overflow-hidden shadow-sm",
                          ...
                          >
                            <div className="size-12 rounded-xl bg-[#F9FAFB] border border-[#F2F0EB] flex items-center justify-center group-hover:bg-white transition-colors">
                              <item.icon className={cn("size-6", formData.objective === item.id ? "text-signal" : "text-[#667085]")} />
                            </div>
                            <div>
                          ...
                          <div className="grid grid-cols-3 gap-4">
                            {[
                              ...
                              { id: "1:1", label: "Square", desc: "Grid & Sidebar", icon: File02 },
                                ...
                                className={cn(
                                  "p-4 rounded-[16px] border text-left transition-all duration-300 relative group shadow-sm",
                ...
                <div className="flex items-center justify-between pt-6">
                  ...
                  <div className="flex items-center gap-6">
                    <button 
                      onClick={nextStep}
                      className="h-16 px-12 rounded-xl gap-4 shadow-sm hover:shadow-md transition-all text-lg bg-[#101828] text-white flex items-center justify-center font-bold"
                    >
